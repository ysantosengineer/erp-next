...
- A parte de produtos da US003 está implementada com SKU/código de barras únicos por empresa, categoria, unidade, fornecedor principal opcional, preços, dimensões, estoque mínimo, busca, filtros, paginação, status e testes. A US003 permanece aberta até armazéns.
- A parte de clientes da US003 está implementada com PF/PJ, CPF/CNPJ obrigatório e único por empresa, endereço principal, limite de crédito decimal, busca, filtros, paginação, status, controle por permissão e testes. A US003 permanece aberta até armazéns.
