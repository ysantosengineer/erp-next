...
- A parte de pedidos da US004 está implementada com fornecedor, depósito, itens dinâmicos, numeração segura, totais, submit, aprovação e cancelamento. A US004 permanece aberta até o recebimento criar a entrada de estoque na etapa seguinte.
