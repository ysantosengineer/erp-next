...
- Depósitos e endereços de estoque concluem o escopo cadastral da US003. O núcleo transacional mantém saldos por endereço e histórico imutável; compras já o utilizam, enquanto a integração automática com vendas (US005) permanece pendente.
