...
- Depósitos e endereços de estoque concluem o escopo cadastral da US003, com códigos únicos no escopo correto, hierarquia física opcional, capacidade lógica, proteção cross-tenant, auditoria, permissões e interface contextual. Saldos e movimentos pertencem às histórias de compras e estoque posteriores.
