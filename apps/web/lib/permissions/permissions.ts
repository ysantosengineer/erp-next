...
export const PERMISSION_LABELS: Readonly<Record<string, string>> = {
  ...
  'inventory.reservations.read': 'Visualizar reservas de estoque',
  'inventory.reserve': 'Reservar estoque para pedidos de venda',
  'inventory.release': 'Liberar reservas de estoque',
  'inventory.ship': 'Realizar baixa de pedidos reservados',
